...
ol.proj.get("EPSG:4326").setExtent([-72.289942, 5.733499, -61.769453, 10.659542]);
var wms_layers = [];
...
lyr_OSMStandard_0.setVisible(true);lyr_Cdigosdeunidades_1.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_Cdigosdeunidades_1];
...
lyr_Cdigosdeunidades_1.on('precompose', function(evt) {
